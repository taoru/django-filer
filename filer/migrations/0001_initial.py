...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('file', filer.fields.multistorage_file.MultiStorageFileField(max_length=191, upload_to=filer.fields.multistorage_file.generate_filename_multistorage, null=True, verbose_name='file', blank=True)),
                ...
                ('original_filename', models.CharField(max_length=191, null=True, verbose_name='original filename', blank=True)),
                ('name', models.CharField(default='', max_length=191, verbose_name='name', blank=True)),
        ...
        operations.append(
            migrations.CreateModel(
                ...
                fields=[
                    ...
                    ('default_alt_text', models.CharField(max_length=191, null=True, verbose_name='default alt text', blank=True)),
                    ('default_caption', models.CharField(max_length=191, null=True, verbose_name='default caption', blank=True)),
                    ('author', models.CharField(max_length=191, null=True, verbose_name='author', blank=True)),
