...
class BaseImage(File):
    ...
    default_alt_text = models.CharField(_('default alt text'), max_length=191, blank=True, null=True)
    default_caption = models.CharField(_('default caption'), max_length=191, blank=True, null=True)
